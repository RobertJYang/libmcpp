...
error_code object_tree_service::update_object_property(const path& object_path, const char* property_name, const void* value, size_t value_size) {
...
std::vector<std::string> object_tree_service::list_children(const path& parent_path, error_code& ec) {
