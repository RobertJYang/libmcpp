...
using message_handler =
    std::function<void(client_id, message_type, const void*, size_t, void*, size_t*)>;
...
public:
    ...
    static void register_options(po::options_description& cli_opts,
        ...
        cfg_opts.add_options()("communication.max_clients", po::value<size_t>()->default_value(100),
                               "通信服务的最大客户端数量")("communication.timeout_ms",
