...
#ifndef MCPP_FUTURE_STATE_HPP
#define MCPP_FUTURE_STATE_HPP
...
template<typename T>
using result_variant_t = typename std::conditional_t<
    std::is_same_v<T, void>, std::variant<std::monostate, std::exception_ptr>,
