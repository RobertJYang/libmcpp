...
public:
    method_invoke_event(context& ctx, std::string_view method_name, const mc::variants& args,
                        std::string_view interface_name, bool is_async) noexcept;
...
private:
    ...
    std::string_view                       m_interface_name;
