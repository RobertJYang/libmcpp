...
public:
    ...
    mc::engine::service* get_service() const override { return nullptr; }
    mc::engine::abstract_object* get_owner() const override { return nullptr; }
    ...
    bool has_interface(std::string_view interface_name) const override { return false; }
    mc::engine::abstract_interface* get_interface(std::string_view interface_name) const override { return nullptr; }
...
public:
    ...
    // property_helper虚函数
    void set_property_type(mc::engine::p_type type) override { m_type = type; }
    mc::engine::p_type get_property_type_enum() const override { return m_type; }
    void set_variant_value(const mc::variant& value) override {}
    mc::variant get_variant_value() const override { return mc::variant(); }
    void set_internal_value(const mc::variant& value) override {}
    bool has_extension_data() const override { return false; }
    void ensure_extension_data() override {}
    void set_ref_object_cache(std::unique_ptr<mc::variant> cache) override { 
        m_cache = std::move(cache);
    }
    mc::variant* get_ref_object_cache() const override { return m_cache.get(); }
    ...
    std::string_view get_signature() const override { return m_signature; }
    uint32_t get_access() const override { return 0; }
    uint64_t get_flags() const override { return 0; }
    mc::engine::abstract_interface* get_interface() const override { return nullptr; }
    ...
    mc::engine::property_changed_signal& property_changed() override { return m_signal; }
...
public:
    void ensure_extension_data() override { has_extension = true; }
    bool has_extension_data() const override { return has_extension; }
    void set_getter_function(std::function<mc::variant()> getter) override { m_getter = getter; }
    void set_setter_function(std::function<void(const mc::variant&)> setter) override { m_setter = setter; }
    void add_connection_slot(mc::connection_type slot) override { connection_count++; }
    void clear_connection_slots() override { connection_count = 0; }
