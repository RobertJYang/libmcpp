...
public:
     ...
     */
    virtual bool matches(mc::string_view value_str) const = 0;

    /**
     * @brief 处理属性值设置
     */
    virtual void process(property_helper* property, mc::string_view value_str) = 0;
...
public:
     ...
     */
    MC_API bool process_property_value(property_helper* property, mc::string_view value_str);
