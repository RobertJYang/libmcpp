...
private:
     ...
     */
    void process_ref_object_from_variant(property_helper* property, mc::string_view ref_object_str);

    /**
     * @brief 初始化引用对象缓存
     */
    void initialize_ref_object_cache(property_helper* property, mc::string_view object_name);
};
