...
public:
     ...
     * @return 连接后的新路径
     */
    path operator/(mc::string_view element) const;
     ...
     * @return 如果路径相等返回true
     */
    bool operator==(mc::string_view p) const
    {
        return m_path == p;
    }
    bool operator!=(mc::string_view p) const
    ...
    friend bool operator==(mc::string_view s, const path& p)
    {
        return p.m_path == s;
    }
    friend bool operator!=(mc::string_view s, const path& p)
     ...
     *
     * @param p 要验证的路径字符串
     * @return 如果是有效的对象路径返回true
     */
    static bool is_valid(mc::string_view p);
     ...
     */
    static bool is_valid_element(mc::string_view element);
