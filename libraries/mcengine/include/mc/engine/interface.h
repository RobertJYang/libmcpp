...
public:
    ...
    const property_type_info* get_property_info(mc::string_view property_name) const override;
    const method_type_info*   get_method_info(mc::string_view method_name) const override;
    const signal_type_info*   get_signal_info(mc::string_view signal_name) const override;
    const property_type_info* get_property_info(const void* prop_addr) const override;

    bool        set_property(mc::string_view property_name, const mc::variant& value) override;
    mc::variant get_property(mc::string_view property_name, int options) const override;
    mc::dict    get_all_properties(int options) const override;

    invoke_result invoke(mc::string_view method_name, const mc::variants& args) override;
    async_result  async_invoke(mc::string_view method_name, const mc::variants& args) override;

    mc::connection_type      connect(mc::string_view signal_name, slot_type slot) override;
    mc::variant              emit(mc::string_view signal_name, const mc::variants& args) override;
...
public:
    ...
    mc::string_view get_interface_name() const override
    {
