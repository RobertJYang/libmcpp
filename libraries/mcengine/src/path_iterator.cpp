...
path_iterator::path_iterator(mc::string_view path) : m_path(path), m_start(0), m_end(0), m_is_initialized(false)
{
    // 去除尾部斜杠
...
mc::string_view path_iterator::current() const
{
...
mc::string_view path_iterator::parent_path() const
{
