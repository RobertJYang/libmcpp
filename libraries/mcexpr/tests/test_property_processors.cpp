...
public:
    ...
    mc::string_view get_position() const override
    {
    ...
    {}
    mc::string_view get_object_path() const override
    {
        static std::string path = "/mock/object";
        return path;
    }
    void set_object_path(mc::string_view path) override
    {}
    void set_position(mc::string_view position) override
    {}
    mc::string_view get_class_name() const override
    {
    ...
    bool has_interface(mc::string_view interface_name) const override
    {
        return false;
    }
    mc::engine::abstract_interface* get_interface(mc::string_view interface_name) const override
    {
        return nullptr;
    }
    ...
    mc::engine::property_base* get_property_base(mc::string_view property_name,
    ...
    mc::connection_type connect(mc::string_view signal_name, mc::engine::slot_type slot,
                                mc::string_view interface_name = {}) override
    {
        return mc::connection_type();
    }
    mc::variant emit(mc::string_view signal_name, const mc::variants& args,
                     mc::string_view interface_name = {}) override
    {
        return mc::variant();
    }
    ...
    bool has_method(mc::string_view method_name, mc::string_view interface_name = {}) const override
    {
        return false;
    }
    mc::engine::invoke_result invoke(mc::string_view method_name, const mc::variants& args = {},
                                     mc::string_view interface_name = {}) override
    {
        return mc::engine::invoke_result();
    }
    mc::result<mc::variant> async_invoke(mc::string_view method_name, const mc::variants& args = {},
                                         mc::string_view interface_name = {}) override
    {
    ...
    void set_property_sync_info(mc::string_view property_name, mc::engine::property_sync_info_ptr info,
                                mc::string_view interface_name) override
    {}

    mc::engine::property_sync_info_ptr get_property_sync_info(mc::string_view property_name,
...
public:
    ...
    void set_getter_function(mc::engine::property_helper::variant_getter getter) override
    {
        m_getter = std::move(getter);
    }
    void set_setter_function(mc::engine::property_helper::variant_setter setter) override
    {
    ...
    mc::string_view get_name() const override
    {
        return m_name;
    }
    ...
    mc::variant get_relate_property(const mc::engine::relate_property& relate_property)
    {
        return mc::variant("mock_relate_value"); // 返回模拟值避免空值
    }

    void set_relate_property(const mc::engine::relate_property& relate_property, const mc::variant& value)
    {
        // 空实现，测试中不需要真正设置
    }
...
private:
    ...
    mc::engine::property_helper::variant_getter    m_getter;
    mc::engine::property_helper::variant_setter    m_setter;
