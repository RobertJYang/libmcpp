...
public:
     ...
     * @note 会递归查找父级上下文
     */
    virtual bool has_variable(mc::string_view name, mc::string_view iface = {}) const;

    /**
     * @brief 判断函数是否存在
     * @note 会递归查找父级上下文
     */
    virtual bool has_function(mc::string_view name, mc::string_view iface = {}) const;
     ...
     * @return 变量值
     */
    virtual const mc::variant& get_variable(mc::string_view name, mc::string_view iface = {}) const;
     ...
     * @return 返回值
     */
    virtual mc::variant invoke(mc::string_view name, const mc::variants& args, mc::string_view iface = {}) const;
...
public:
     ...
     */
    const mc::variant& get_variable(mc::string_view name, mc::string_view iface = {}) const override;

    /**
     * @brief 判断变量是否存在
     * @note 会递归查找父级上下文
     */
    bool has_variable(mc::string_view name, mc::string_view iface = {}) const override;
     ...
     * @note 会递归查找父级上下文
     */
    bool has_function(mc::string_view name, mc::string_view iface = {}) const override;
     ...
     * @return 返回值
     */
    mc::variant invoke(mc::string_view name, const mc::variants& args, mc::string_view iface = {}) const override;
