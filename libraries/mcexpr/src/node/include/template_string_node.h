...
public:
    template_string_node(mc::array<mc::string> text_parts, node_ptrs expressions)
    ...
    const mc::array<mc::string>& get_text_parts() const
    {
        return m_text_parts;
    }
...
private:
    mc::array<mc::string> m_text_parts;  // 文本部分
