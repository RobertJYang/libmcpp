...
#include "node/include/conditional_node.h"
...
mc::string conditional_node::to_string() const
{
...
{
    return mc::make_shared<conditional_node>(std::move(condition), std::move(true_branch), std::move(false_branch));
}
