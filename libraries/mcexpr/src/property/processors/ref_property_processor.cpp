...
bool ref_property_processor::matches(mc::string_view value_str) const
{
    return value_str.substr(0, 2) == "#/" && value_str.find('.') != mc::string_view::npos;
}

void ref_property_processor::process(property_helper* property, mc::string_view value_str)
{
