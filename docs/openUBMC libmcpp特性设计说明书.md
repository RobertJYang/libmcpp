...
_【关键内容】
介绍关键特性定位，对于特性面向的使用客户和市场范围，基于需求分析明确说明特性设计要达成的目的。
对本方案的概况介绍。简述特性背景信息，并说明本文档所包含的主要内容和适用范围等。_
...
_本特性作为面向互联网市场产品，主要面向国内头部互联网公司提供硬盘带外管理能力。产品集成到openUBMC固件当中，满足客户硬盘管理运维需求。_

## 1.1目的

_【关键内容】_

_本文档以xxx文档/issue为分析指导，对xxx模块或者xxx特性的功能进行设计，明确数据结构和主要处理过程，作为后续软件开发人员、测试人员的指导。_

___注意：__ 后续章节基于实际情况进行灵活裁剪_
...
| 场景编号     | 编号1 | 编号2 | 编号3 | 编号4 |
| :----------- | :---: | :---: | :---: | ----: |
| 场景名称     | 场景1 | 场景2 | 场景3 | 场景4 |
| 特性是否相关 |  √  |  √  |  √  |    √ |
...
<table>
    ...
    <tr>
        ...
        <td>根据威胁的风险等级、工作量、版本策略等因素制定落地计划。例如：当前openUBMC 25.3.0版本落地。</td>
    </tr>
    <tr>
        <td>xxx</td>
        <td>xxx</td>
    ...
    <tr>
        ...
        <td>根据威胁的风险等级、工作量、版本策略等因素制定落地计划。例如：openUBMC 25.3.0版本落地。</td>
    </tr>
    <tr>
        <td>xxx</td>
        <td>xxx</td>
